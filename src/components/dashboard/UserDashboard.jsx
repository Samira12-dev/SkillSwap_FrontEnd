    ...
    return (
        <div className="user-dashboard">
            ...
            <div className="welcome-header">
                <h2>
                    Good morning, Samira! <MdWavingHand className="gold-icon"  />
                </h2>
                ...
                <div className="left-section">
                    ...
                    <div className="dashboard-card-box">
                        ...
                        <div className="actions-grid">
                            ...
                            <Link
                                to="/messages"
                                className="action-btn purple-light"
                            >
                                <MdMessage />
                                <span>Messages</span>
                            </Link>
                            ...
                            <Link
                                to="/notifications"
                                className="action-btn red-light"
                            >
                                <MdNotifications />
                    ...
                    <div className="dashboard-card-box">
                        ...
                        <div className="request-box">
                            ...
                            <p className="request-text">
                                Hi Alex! I'd love to learn React from you.
                                I can offer comprehensive UI/UX design
                                sessions in exchange. I think we'd make a
                                great learning pair!
                            </p>
                    ...
                    <div className="dashboard-card-box">
                        ...
                        <div className="session-item">
                            ...
                            <div className="session-info">
                                <h4>
                                    UI/UX Design with Sarah
                                </h4>

                                <p>
                                    11:00 AM - 90min • Online
                                </p>
                            </div>
                        ...
                        <div className="msg-list">
                            ...
                            <div className="msg-item">
                                ...
                                <div className="msg-content">
                                    ...
                                    <p>
                                        Your design portfolio is really
                                        impressive!
                                    </p>
