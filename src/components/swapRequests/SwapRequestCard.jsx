...
import { ArrowRight, Check, Clock3, MessageSquare, X } from "lucide-react";
...
function SwapRequestCard({
    ...
    const userName =
        type === "received"
            ? request.senderName
            : request.receiverName || request.senderName;
    ...
    return (
        <div className="swap-request-item">
            <div className="swap-request-user">
                ...
                <div>
                    <h3>{userName}</h3>
                    <p>{request.senderCity || request.receiverCity}</p>
                </div>
            </div>
            ...
            <div className="swap-request-main">
                <div className="swap-exchange">
                    <div className="swap-skill">
                        <span>OFFERS</span>
                        <strong>{request.skillOfferedName}</strong>
                    </div>
                    ...
                    <div className="swap-skill">
                        <span>WANTS</span>
                        <strong>{request.skillWantedName}</strong>
                    </div>
                </div>
            ...
            <div className="swap-request-actions">
                {type === "received" && request.swapStatus === "PENDING" && (
                    <>
                        <button
                ...
                {type === "sent" && request.swapStatus === "PENDING" && (
                    <button
                ...
                {request.swapStatus === "ACCEPTED" && request.conversationId && (
                    <Link
